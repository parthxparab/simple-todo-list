...
var taskInput = document.getElementById("new-task1"); // new-task
...
var getDatafromJson = function () {
  fetch("/assets/js/data.json")
    ...
    .then(function (data) {
      data.map((task) => {
        console.log("Add Task from json...");
        //Create a new list item with the text from the #new-task:
        var listItem = createNewTaskElement(task.title);
        //Append listItem to completedTasksHolder or incompleteTasksHolder
